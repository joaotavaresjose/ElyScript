function Header({ currentPage, onPageChange }) {
  try {
    return (
      <header className="bg-gradient-to-r from-red-600 via-red-700 to-red-800 text-white shadow-lg" data-name="header" data-file="components/Header.js">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-shadow">ElyScript</h1>
                <p className="text-red-100 text-xs md:text-sm">Automação VFS Global Angola</p>
              </div>
            </div>
