function Loader() {
  try {
    return (
      <div
        className="fixed inset-0 bg-gradient-to-br from-red-500 to-red-700 z-50 flex items-center justify-center"
        data-name="loader"
      ...
      >
        <div className="text-center">
          ...
          <div className="text-white font-bold text-2xl mb-2 animate-pulse">
            ElyScript
          </div>
          <div className="text-red-100 animate-pulse">
            Carregando sistema...
          </div>
        </div>
      </div>
