function Footer() {
  try {
    return (
      <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-12 mt-16" data-name="footer" data-file="components/Footer.js">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 mb-4 max-w-md">
                ...
                Criamos scripts inteligentes que economizam tempo e reduzem erros.
              </p>
              <div className="flex space-x-4">
                ...
                <div className="w-8 h-8 bg-red-600 rounded-full flex items-center justify-center cursor-pointer hover:bg-red-700 transition-colors">
                  <div className="icon-twitter text-white text-sm"></div>
                </div>
                <div className="w-8 h-8 bg-red-600 rounded-full flex items-center justify-center cursor-pointer hover:bg-red-700 transition-colors">
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4 text-red-400">Recursos</h4>
